...
class profile_005 extends StatefulWidget {
  ...
  profile_005.Details(this.id, this.name, this.nickName, this.birthYYYY,
      this.birthMM, this.birthDD, this.personality, this.skill, this.myBoom,
      this.recentThing, this.offDay, this.win1BillionYen, this.reborn,
      this.wish,
      this.myBestTheme1, this.teme1MyBest1, this.teme1MyBest2,
      this.teme1MyBest3,
      this.myBestTheme2, this.teme2MyBest1, this.teme2MyBest2,
      this.teme2MyBest3, this.koshinFlg);
